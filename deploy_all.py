...
# ================= DEFAULT VALUES =================
DEFAULT_CLUSTER = "tfy-aai-computeplane-play"
DEFAULT_WORKSPACE = "snl-ws"
DEFAULT_BASE_DOMAIN = "tf-play.rpaworker.com"
DEFAULT_EMAIL = "snehil.ajada@automationanywhere.com"

DEFAULT_ML_REPO = "snl-ml-repo"
DEFAULT_STORAGE_FQN = "aai-dev:aws:tfy-aai-computeplane-play:blob-storage:blob"
DEFAULT_VOLUME = "snl-vol6"

DEFAULT_HF_TOKEN = "hf_xxxxxxxxxxxxxxxxxxxxxx"   # Same token is OK
DEFAULT_SECRET_VAL = "mysecret123"
DEFAULT_PASSWORD_SECRET_FQN = "tfy-secret://aai-dev:snl-volbrow:password"
